  ...
  return (
    <section className="relative pt-24 pb-32 flex items-center justify-center overflow-hidden min-h-[90vh] bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 start-1/4 w-[30rem] h-[30rem] bg-indigo-200/50 dark:bg-indigo-600/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] opacity-60 animate-blob"></div>
        <div className="absolute top-0 end-1/4 w-[30rem] h-[30rem] bg-blue-200/50 dark:bg-blue-500/30 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] opacity-60 animate-blob animation-delay-2000"></div>
        <div className="absolute -bottom-32 start-1/2 w-[30rem] h-[30rem] bg-teal-100/50 dark:bg-emerald-500/20 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] opacity-60 animate-blob animation-delay-4000"></div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center md:justify-start">
              ...
              >
                {t('viewExperience')}
                <ArrowDown className="ms-2 -me-1 h-5 w-5 animate-bounce" aria-hidden="true" />
              </a>
              <a
              ...
              >
                {t('downloadCV')}
                <FileText className="ms-2 -me-1 h-5 w-5" aria-hidden="true" />
              </a>
            </div>
          </motion.div>
